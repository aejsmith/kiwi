...
typedef struct fs_type {
	...
	bool (*probe)(handle_t *device, const char *uuid);
...
typedef struct fs_mount {
	...
	handle_t *device;		/**< Handle to device that the filesystem resides on. */
...
extern handle_t *fs_file_from_memory(const void *buf, size_t size);
extern int fs_file_open(const char *path, int flags, handle_t **handlep);
extern int fs_file_read(handle_t *handle, void *buf, size_t count, size_t *bytesp);
extern int fs_file_pread(handle_t *handle, void *buf, size_t count, offset_t offset, size_t *bytesp);
extern int fs_file_write(handle_t *handle, const void *buf, size_t count, size_t *bytesp);
extern int fs_file_pwrite(handle_t *handle, const void *buf, size_t count, offset_t offset, size_t *bytesp);
extern int fs_file_resize(handle_t *handle, offset_t size);

extern int fs_dir_create(const char *path);
extern int fs_dir_open(const char *path, int flags, handle_t **handlep);
extern int fs_dir_read(handle_t *handle, fs_dir_entry_t *buf, size_t size);

extern int fs_handle_seek(handle_t *handle, int action, rel_offset_t offset, offset_t *newp);
