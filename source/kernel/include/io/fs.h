...
extern int fs_file_open(const char *path, int flags, khandle_t **handlep);
extern int fs_file_read(khandle_t *handle, void *buf, size_t count, size_t *bytesp);
extern int fs_file_pread(khandle_t *handle, void *buf, size_t count, offset_t offset, size_t *bytesp);
extern int fs_file_write(khandle_t *handle, const void *buf, size_t count, size_t *bytesp);
extern int fs_file_pwrite(khandle_t *handle, const void *buf, size_t count, offset_t offset, size_t *bytesp);
extern int fs_file_resize(khandle_t *handle, offset_t size);

extern int fs_dir_create(const char *path);
extern int fs_dir_open(const char *path, int flags, khandle_t **handlep);
extern int fs_dir_read(khandle_t *handle, fs_dir_entry_t *buf, size_t size);

extern int fs_handle_seek(khandle_t *handle, int action, rel_offset_t offset, offset_t *newp);
extern int fs_handle_info(khandle_t *handle, fs_info_t *info);
extern int fs_handle_sync(khandle_t *handle);
