...
/* Misc macro defines. TODO: fprintf/abort */
#define ABORT                   do { printf("*** libc fatal: dlmalloc abort\n"); while(1); } while(0)
#define USAGE_ERROR_ACTION(m,p) \
        do { \
                printf("*** libc fatal: dlmalloc usage error (%s:%d): 0x%p, 0x%p (ret: 0x%p)\n", \
