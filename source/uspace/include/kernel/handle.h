...
extern int handle_wait(handle_t handle, int event, useconds_t timeout);
extern int handle_wait_multiple(handle_t *handles, int *events, size_t count, useconds_t timeout);
